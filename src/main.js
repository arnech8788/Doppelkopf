...
export function renderMehrScreen(){
  ...
  html+='<div id="versionLabel" style="text-align:center;margin-top:24px;font-size:10px;color:var(--tx3);opacity:.5;cursor:default;-webkit-user-select:none;user-select:none" onclick="handleVersionTap()">v6.37 · 12.06.2026 17:45</div>';
  el.innerHTML=html;
  renderArchiveList();
  renderTurnierSetup();
