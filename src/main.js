...
export function renderMehrScreen(){
  ...
  html+='<div id="versionLabel" style="text-align:center;margin-top:24px;font-size:10px;color:var(--tx3);opacity:.5;cursor:default;-webkit-user-select:none;user-select:none" onclick="handleVersionTap()">v6.21 · 10.06.2026 14:30</div>';
  el.innerHTML=html;
  renderArchiveList();
  renderTurnierSetup();
...
export function openChangelogModal(){
  ...
  html+='<div class="card">';
  const log=[
    {v:'6.21',d:'10.06.2026 14:30',t:'Doppelkopf-Spiel (Beta): Neuer 🐞-Button (in der Steuerleiste und im Ergebnis-Screen) zum Kopieren des Spielstands inkl. Notizfeld. So kannst du zu einem konkreten Bot-Zug etwas notieren und den kompletten, exakt nachstellbaren Spielstand kopieren – zum Verbessern der Computer-Spielweise.'},
