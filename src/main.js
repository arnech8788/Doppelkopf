...
export function renderMehrScreen(){
  ...
  html+='<div id="versionLabel" style="text-align:center;margin-top:24px;font-size:10px;color:var(--tx3);opacity:.5;cursor:default;-webkit-user-select:none;user-select:none" onclick="handleVersionTap()">v6.17 · 10.06.2026 14:00</div>';
  el.innerHTML=html;
  renderArchiveList();
  renderTurnierSetup();
...
Object.assign(window,
  ...
  setup, eingabe, tabelle, stats, archiv, turnier, admin, cloud, game, share
);
